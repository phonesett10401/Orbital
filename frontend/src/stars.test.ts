...
/*
 * The block that tested `skyRadius` is gone with the function (D164): it found
 * a sky radius that survived MapLibre's far plane, and the solar system does
 * not borrow that camera any more.
 */
